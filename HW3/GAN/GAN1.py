...
dataloader = torch.utils.data.DataLoader(data.DATA(args),
                                                   batch_size=args.train_batch, 
...
for epoch in range(num_epochs):
    ...
    save_model(netD, os.path.join(args.save_dir,'dis' , 'dis_{}.pth.tar'.format(epoch)))
    save_model(netG, os.path.join(args.save_dir,'gen' , 'gen_{}.pth.tar'.format(epoch)))
