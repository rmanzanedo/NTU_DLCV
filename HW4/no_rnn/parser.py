...
def arg_parse():
    ...
    parser.add_argument('--load_model', default='log/model_best.pth.tar', type=str,
                        help="best_model")
    parser.add_argument('--valid', default='../hw4_data/TrimmedVideos/video/valid', type=str,
                        help="best_model")
    parser.add_argument('--gt', default='../hw4_data/TrimmedVideos/label/gt_valid.csv', type=str,
                        help="best_model")
